...
func TestForecastAPIService_GetByCityIdAndPeriod_CityIdRequired(t *testing.T) {
...
func TestForecastAPIService_GetByCityIdAndPeriod_CityNotFound(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestForecastAPIService_GetByCityIdAndPeriod_InvalidPeriod(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestForecastAPIService_GetByCityIdAndPeriod_ValidPeriod(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestForecastAPIService_GetByCityIdAndPeriod_ErrorFromFindByID(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestForecastAPIService_GetByCityIdAndPeriod_ErrorFromHandleCurrentData(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestForecastAPIService_GetByCityIdAndPeriod_ErrorFromFindByCityIdAndPeriodDays(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
